...
size(B)     %% returns the length of the largest array dimension in B
% 1     2

length(B)   %%eturns a row vector whose elements are the lengths of the corresponding dimensions of B
% 2
